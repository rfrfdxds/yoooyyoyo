...
setInterval(() => {
  http.get(`http://fyoio-k2.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '711366064667361292'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '711635229512826941'; // تعديل مهم ايدي الروم الصوتي
...
//تغير الحالة
const developers = ["705324909777125508","697875847025262644","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
...
const youtube = new YouTube("AIzaSyA_GsYhch9jTAGvzrxngqhxE574LwuCvUo"); //تعديل مهم عدل الاي بي اي بواحد جديد او خليه زي ماهو
